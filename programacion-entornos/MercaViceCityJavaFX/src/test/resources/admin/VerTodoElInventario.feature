Feature: Como gerente quiero ver todos los productos para conocer el inventario
  ...
  Scenario: Gerente quiere ver lista de productos
    When Gerente elige ver lista de productos
    Then Mostrar
    #Id 1, Nombre Kitkat normal, Precio 1, Stock 2;
    #Id 2, Nombre Kitkat blanco, Precio 1.2, Stock 3;
    #Id 3, Nombre Kitkat negro, Precio 1.4, Stock 5;
